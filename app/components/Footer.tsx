export default function Footer() {
  return (
    <footer className="relative isolate grid min-h-[320px] place-content-center overflow-hidden px-[7%] py-[4.5rem] text-center text-[var(--ivory)] max-md:min-h-[360px] max-md:px-5 max-md:py-[4.5rem] max-[480px]:min-h-[340px] max-[480px]:px-4 max-[480px]:py-16">
