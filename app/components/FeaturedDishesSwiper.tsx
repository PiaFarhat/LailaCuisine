...
const titleClass =
  "mb-2 min-h-[3.1rem] text-[1.24rem] font-medium leading-[1.25] text-[var(--burgundy)]";
const descriptionClass =
  "m-0 flex-1 text-[0.95rem] leading-[1.62] text-[rgba(43,33,24,0.76)]";
const priceClass =
  "inline-block border border-[rgba(198,161,91,0.34)] bg-[rgba(198,161,91,0.16)] px-[0.65rem] py-[0.34rem] text-[0.83rem] font-bold leading-[1.25] tracking-[0.045em] text-[var(--wine)]";
const linkClass =
      ...
      <div className={mediaClass}>
        {item.image ? (
          <Image
            ...
            width={720}
            height={405}
            sizes="(max-width: 479px) 86vw, (max-width: 767px) 58vw, (max-width: 1023px) 44vw, 320px"
